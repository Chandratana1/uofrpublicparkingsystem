...
$TimingListener = new TimingListener();
EventManager::instance()->on($TimingListener);
//require_once __DIR__ . DS . 'events.php';


//$this->loadComponent('ClassRegistry');

//$user = ClassRegistry::init('User');
//$user->getEventManager()->on(new UserListener());

//$TimingListener = new TimingListener();
//$this->Timings->getEventManager()->on($TimingListener);
