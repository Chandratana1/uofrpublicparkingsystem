...
class ProfilesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->maxLength('LicenseNumber', 255)
            ->requirePresence('LicenseNumber', 'create')
            ->notEmptyString('LicenseNumber');

        $validator
            ->scalar('VehicleNumber')
            ->maxLength('VehicleNumber', 255)
            ->requirePresence('VehicleNumber', 'create')
            ->notEmptyString('VehicleNumber');
